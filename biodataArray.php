        ...
        <div class="sisiTengah">
            <div class="tabel1">
                ...
                <td>
                    ...
                    <?php
                        $pendidikan = array(
                            array('TK' => 'TK Tunas Harapan Jaya', 
            ...
            <div>
                <table class="table2">
                    ...
                    <?php foreach ($pendidikan as $pen) : ?>
                        <tr class="a"><td>SMA</td> <td>: <?php echo $pen['SMA']; ?> </td></tr>
                        <tr class="b"><td>SMP</td> <td>: <?php echo $pen['SMP']; ?> </td></tr>
                        <tr class="a"><td>SD</td> <td>: <?php echo $pen['SD']; ?> </td></tr>
                        <tr class="b"><td>TK</td> <td>: <?php echo $pen['TK']; ?> </td></tr>                    
                    <?php endforeach; ?>
